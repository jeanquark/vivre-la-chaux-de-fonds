...
export const actions = {
    ...
    async updateSection({ commit, dispatch }, form) {
        try {
            ...
            dispatch('pages/fetchPages', {}, { root: true })

            // for (let page of data.updatedSection.pages) {
			// 	console.log('page3: ', page)
            //     dispatch('pages/fetchPageById', { pageId: page.id }, { root: true })
            // }
        } catch (error) {
            console.log('error: ', error)
            throw error
