<template>
    <b-modal size="md" id="createLinkModal" title="Créer un lien" ok-disabled no-close-on-esc no-close-on-backdrop @close="closeModal">
        ...
        <!-- <b-form-group label="select-link-type">
            <b-form-radio name="link-type" value="internal" :stacked="false" v-model="linkType">Interne</b-form-radio>
            <b-form-radio name="link-type" value="external" :stacked="false" v-model="linkType">Externe</b-form-radio>
        </b-form-group> -->

        <!-- <b-form-group label="Lien interne:" label-for="internalLink" v-if="linkType === 'internal'">
            <b-form-select id="internalLink" name="internalLink" :options="pagesArray" text-field="name" value-field="slug" v-model="linkPage.internal"></b-form-select>
        </b-form-group> -->

        <!-- <b-form-group label="Lien interne:" label-for="internalLink2" v-if="linkType === 'internal'">
            <b-form-select id="internalLink2" name="internalLink2" :options="pages" text-field="name" value-field="id" v-model="linkPage.internal"></b-form-select>
        </b-form-group> -->
...
props: ['selectedText'],
    ...
    methods: {
        insertLink() {
            ...
            // }
            // return
            this.$emit('insertLink', { linkType: this.linkType, linkPage: this.linkPage, linkText: this.selectedText })
